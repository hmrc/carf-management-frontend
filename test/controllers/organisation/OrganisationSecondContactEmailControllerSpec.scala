  ...
  "OrganisationSecondContactEmail Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(form, NormalMode, secondContactName, organisationName)(
          request,
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId)
        .withPage(OrganisationSecondContactNamePage, secondContactName)
        .withPage(OverwritableOrganisationName, organisationName)
        .withPage(OrganisationSecondContactEmailPage, "anexampleevalidemail@email.com")
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(boundForm, NormalMode, secondContactName, organisationName)(
          request,
          messages(application)
        ).toString
      }
